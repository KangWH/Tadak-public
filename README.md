...
1. [다운로드 페이지](https://github.com/KangWH/Tadak-public/releases/tag/0.1.1)에서 최신 버전의 설치 파일(`Tadak-macOS-0.1.1.pkg`)을 내려받은 다음 실행합니다.
...
타탁 0.1.1의 내부 조합 엔진은 날개셋 한글 입력기 버전 10.85를 기준으로 개발되었습니다.
